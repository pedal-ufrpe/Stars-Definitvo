...
public class GerarTodosA2 {
   ...
   /* static double minDispVCold = 0.998987302436096;
    ...
    public static void main(String[] args){
        ...
        Map<String, ArrayList<Cromossomo>> dicRank = new HashMap<>();
        ...
        System.out.println("A2 começou em " + tempo1);
        ...
        ranquear(cromossomos, dicRank, base);
    ...
    private static void ranquear(ArrayList<Cromossomo> individuos, Map<String, ArrayList<Cromossomo>> dicRank, String base){//aplicacao do non-dominated sort
        ...
        try {
            FileWriter arq = new FileWriter("a2 - ranques"+  " base" + base +".txt");
            PrintWriter gravarArq = new PrintWriter(arq);
