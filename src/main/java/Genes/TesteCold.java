...
public class TesteCold {
    ...
    public static void main(String[] args){
                ...
                ups.setIdVert("2");
                            ...
                            for (Componente ups2 : dicComp.get("UPS_5kVA")) {
                                ...
                                for (Componente sts : dicComp.get("STS")) {
                                    ...
                                    */
                                    atual.calcularMetricasCold("Script.mry");
                                    ...
                                    //gravarArq.printf(dado);
                                    //normalizar os dados cold, fitness so funcionará apos isso
                                    ...
                                    dado2 +=  "\tfitness: " + atual.fitness() + "\tdispN  " + atual.getAvailabilityCold()+ "\tcustoN  " + atual.getTotalCostCold()+ "\texerN  " + atual.getOperationalExergyCold();
        ...
        try {
            FileWriter arq = new FileWriter("testeCold.txt");
